var http = require('http'),
    ...
    httpKeepAliveAgent = require('agentkeepalive'),
    httpsKeepAliveAgent = require('agentkeepalive').HttpsAgent,
    config = require('./config.js');


var keepAliveAgentHttp = new httpKeepAliveAgent({
    maxSockets: 2000
});
var keepAliveAgentHttps = new httpsKeepAliveAgent({
    maxSockets: 2000
});
...
exports.keepAliveAgentHttp = keepAliveAgentHttp;
exports.keepAliveAgentHttps = keepAliveAgentHttps;
